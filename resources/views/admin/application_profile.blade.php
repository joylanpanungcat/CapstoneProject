...
#business_info_view2 .business-modal-body {
    height:400px;
    overflow-y: auto;
    align-content: center;
    position: relative;
}
#business_info_view2 .business-modal-footer{
    position: sticky;
}
.no_user{
    align-content: center;
...
#Print_certificate .modal-header{
    display: flex;
    justify-content: end;
}
#Print_certificate .modal-body{
    height: 80vh;
    overflow-y: auto;
}
#receipt{
...
<div class="right_col" role="main" >
                                        ...
                                        <thead>
                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                                ...
                                                {{-- <button type='' name='view' class='btn btn-success view viewReport'
                                                  id="{{$inspection_details[0]->inspection_details[$index]['applicationId']}}"><i class='fa fa-eye'></i></button> --}}
                                                  <button  class="btn viewReport view" id="{{$inspection_details[0]->inspection_details[$index]['applicationId']}}" data-toggle="modal"><i class="fa fa-eye"></i></button>
                                                @else
 ...
 <div id="mySidebar" class="sidebar">
    ...
    <div id="business_info_view2" class="modal" data-backdrop="static" data-keyboard="false" tabindex="-1"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl view-modal-dialog">
            <div class="modal-content view-modal-content ">
                <div class="modal-header">
    ...
    <div id="addFolder3" class="modal" data-backdrop="static" data-keyboard="false" tabindex="-1"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl view-modal-dialog">
            <div class="modal-content  view-modal-content ">
                <div class="modal-header ">
                    <h5 class="modal-title">Inspection Report</h5>
                                                  ...
                                                  <div class="topcontainer">
                                                    ...
                                                    <div class="personalinfo">
                                                        <div>
                                                            ...
                                                            <input type="text" value="" class="textboxinfo" id="applicationIdInspection" readonly>
                                                    ...
                                                    <div class="third">
                                                        <form>
                                                            ...
                                                            <input type="text" value="" id="inspection_of">
                                                        </form>
                                                        <div class="for-attn">
                                                    ...
                                                    <div class="fourth">
                                                        <form>
                                                            ...
                                                            <input type="text" value="" style="width: 214px;" id="order_no" >
                                                        </form>

                                                        <form>
                                                            <label>DATE ISSUED</label>
                                                            <input type="text" value="" id="date_issued2" readonly>
                                                        </form>
                                                        ...
                                                        <ul class="generalinfo33">
                                                         ...
                                                         <div class="generalinfo4">
                                                             <ul class="generalinfo44">
                                                                 ...
                                                                 <li><label>Date Issued<input type="text" id="date_issued123"></label></li>
                                                        ...
                                                        <div class="mainborder2">
                                                            ...
                                                            <div class="acknowledgement" >
                                                                ...
                                                                <div style="padding-top: 20px;">
                                                                    <ul class="listcon">
                                                                    <li>
                                                                    <form style="padding-right: 109px;">
                                                                ...
                                                                <div style="padding-top: 20px;">
                                                                    ...
                                                                    <li>
                                                                    <form>
                                                                    <input type="text" value="" style="width: 315px;" id="team_leader" >
                                                                    </form>
                                                                ...
                                                                <div style="padding-top: 50px; position: relative; left: 560px; padding-bottom: 50px;">
                                                                    ...
                                                                    <form>
                                                                        <input type="text" value="" style="width: 215px;" id="chiefEnforcement" >
                                                                        </form>
    ...
    <div id="Print_certificate" class="modal" data-keyboard="false" tabindex="-1"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg">
          <div class="modal-content " id="print_content">
            <div class="modal-header">
                <div class="button_print_cert" >
                    <div id="updateCertButton" style="margin-right: 10px"></div>
...
{{-- generate receipt modal  --}}
      <div id="payment_view_modal123" class="modal" data-backdrop="static" data-keyboard="false" tabindex="-1"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
          <div class="modal-content">
            <div class="container">
                <div class="row">
                          ...
                          <tbody id="nature_payment_body">
                            ...
                            <div class="form-group group2">
                              ...
                              <div class="form-group group2  " style="float:right;margin-top: 30px;">
                                <h5><b>BY AUTHORITY OF </b><span><div class="search_applicaintDiv"> <input type="text" name="" class="authority_name " id="authority_of" /></div></span></h5>
                                <label style="float: right;">(Name of City/Municipal Fire Marshal)</label><br><br><br><br>


                                <div class="search_applicaintDiv2"><input type="text" name="" class="authority_name" id='fee_assessor'></div>
...
function getData(){
    $.ajax({
        url:"{{ route('getDefault') }}",
        type:'get',
        dataType: 'json',
        success:function(data){
           $.each(data.data, function($key , $value){
                availableTags.push($value['authority_of']);
                availableTags.push($value['fee_assessor']);
           });
        }
    })
}
...
function loadSuggest(){
    $( "#authority_of" ).autocomplete({
        source: availableTags,
    });
}
$( "#authority_of" ).autocomplete( "option", "appendTo", ".search_applicaintDiv" );

loadSuggest2();
function loadSuggest2(){
    $( "#fee_assessor" ).autocomplete({
        source: availableTags,
    });
}
$( "#fee_assessor " ).autocomplete( "option", "appendTo", ".search_applicaintDiv2" );
$( "#chiefMarshal " ).autocomplete( "option", "appendTo", ".search_applicaintDiv3" );
...
$('.business_info_button123').on('click',function(e){
            e.preventDefault();
            $('#viewDocuments').modal('show');
            $('.modal-dialog').draggable({
                     handle: ".modal-header"
...
$('.business_info_button').on('click',function(e){
    ...
    $.ajax({
        ...
        dataType:'json',
        success:function(data){
    $('#business_info_view2').modal('show');
...
$('#date_issued , #inspection_of , #order_no , #team_leader , #chiefEnforcement').on('input',function(){
   if(($('#inspection_of').change() || $('#date_issued').change() || $('#order_no').change() || $('#team_leader').change() ||  $('#chiefEnforcement').change())
    && ($('#inspection_of').val() !== '' || $('#date_issued').val() !== '' || $('#order_no').val() !== ''  || $('#chiefEnforcement').val() !== '') ){
    $('#updateInspectionDetailsButton').css('display','block');
    $('#updateInspectionDetailsButton').html('<button type="button" class="btn btn-info udpateInspectionDetials"  ><i class="fa fa-check"> </i> Update</button>');
   }else{
...
$(document).on('click','.udpateInspectionDetials',function(e){
    var applicationId = $('#applicationIdInspection').val();
    var date_issued = $('#date_issued').val();
    var inspection_of = $('#inspection_of').val();
    var order_no = $('#order_no').val();
    var team_leader = $('#team_leader').val();
    var chief = $('#chiefEnforcement').val();
    var letter_head = $('#noticeLetterHead').val();
    var date_issuedNotice = $('#dateNotice').val();
    var city_marshal = $('#chiefMarshal').val();

    var letter_headNoticeToCorrect = $('#letter_headNoticeToCorrect').val();
    var date_issuedToCorrect = $('#date_issuedToCorrect').val();
    var servicing_bank = $('#servicing_bank').val();
    var truly_yours = $('#truly_yours').val();

    $.ajax({
        type: 'post',
        url: '{{route('udpateInspectionDetials') }}',
        data:{
            applicationId:applicationId,
            ...
            date_issuedNotice :date_issuedNotice,
            city_marshal:city_marshal,
            letter_headNoticeToCorrect:letter_headNoticeToCorrect,
            date_issuedToCorrect:date_issuedToCorrect,
            servicing_bank:servicing_bank,
            truly_yours:truly_yours
        },
        dataType: 'json',
        success:function(data){
...
$(document).on('input','#noticeLetterHead, #dateNotice , #chiefMarshal',function(){
    loadSuggest2();
   if(($('#noticeLetterHead').change() || $('#dateNotice').change() || $('#chiefMarshal').change()  )
    && ($('#noticeLetterHead').val() !== '' || $('#dateNotice').val() !== '' || $('#chiefMarshal').val() !== '') ){
...
$(document).on('input','#letter_headNoticeToCorrect, #date_issuedToCorrect , #servicing_bank, #truly_yours',function(){
   if(($('#letter_headNoticeToCorrect').change() || $('#date_issuedToCorrect').change() || $('#servicing_bank').change() || $('#truly_yours').change() )
    && ($('#letter_headNoticeToCorrect').val() !== '' || $('#date_issuedToCorrect').val() !== '' || $('#servicing_bank').val() !== '' || $('#truly_yours').val() !== '') ){
    $('#updateInspectionDetailsButton').css('display','block');
    $('#updateInspectionDetailsButton').html('<button type="button" class="btn btn-info udpateInspectionDetials"  ><i class="fa fa-check"> </i> Update</button>');
   }else{
    $('#updateInspectionDetailsButton').css('display','none');
...
$(document).on('input','#fsec_noCert, #date_issuedCert , .issued_for, #chiefCert, #marshalCert',function(){
   if(($('#fsec_noCert').change() || $('#date_issuedCert').change() || $('.issued_for').change() || $('#chiefCert').change() || $('#marshalCert').change() )
    && ($('#fsec_noCert').val() !== '' || $('#date_issuedCert').val() !== '' || $('.issued_for').val() !== '' || $('#chiefCert').val() !== ''  || $('#marshalCert').val() !== '') ){
    $('#updateCertButton').css('display','block');
    $('#updateCertButton').html('<button type="button" class="btn btn-info updateCertDetails"  ><i class="fa fa-check"> </i> Update</button>');
   }else{
    $('#updateCertButton').css('display','none');
   }
});

$(document).on('click','.updateCertDetails',function(e){
    e.preventDefault();
    var fsec_noCert = $('#fsec_noCert').val();
    var applicationId = $('#applicationIdCert').val();
    var date_issuedCert = $('#date_issuedCert').val();
...
$(document).on('click','.viewInspectionReportSingle',function(){
    ...
    if(data.noticeToCorrect.length > 0){
      ...
      $.each(data.data,function(key, value){
        ...
        $('#date_issued2').val(value['date_issued']);
        $('#inspection_of').val(value['inspection_of']);
        $('#order_no').val(value['order_no']);
        $('#team_leader').val(value['team_leader']);
        $('#chiefEnforcement').val(value['chief']);
        $('#applicationIdInspection').css('display','none');
        $('#applicationIdInspection').val(value['applicationId']);
  ...
  $.ajax({
    ...
    success:function(data){
      $('#Print_certificate').modal('show');
       $('#printModalBody').html(data.output);
    }
  })
