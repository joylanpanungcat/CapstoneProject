  ...
  <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                <span>Welcome,</span>
                <h2>{{Session::get('inspectorId')['username']}}</h2>
              </div>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li><a href="{{ route('dashboard_inspector') }}"><i class="fa fa-home"></i> Home </a>
                  </li>
               
                  <li><a href="{{ route('for_inspection') }}"><i class="fa fa-file"></i>Application For Inspection</a>
                    <li><a href="{{ route('inspected_application') }}"><i class="fa fa-list"></i>Inspected Application</a>
                  </li>
                  <li><a href="{{ route('inspection_history') }}" class="noti_app"><i class="fa fa-history "></i> Inspection History <span class="badge bg-danger" id="count_application"></span> </a>
                     <li><a href="{{ route('profile_view') }}" ><i class="fa fa-user"></i>Profile</a>
                    
                  </li>
                    
                  </li>
                  <li><a href="{{ route('logoutInspector') }}"><i class="fa fa-sign-out "></i> Logout </a>
                        ...
                        <ul class=" navbar-right">
                          ...
                          <li class="nav-item dropdown open" style="padding-left: 15px;">
                            <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                              <img src="{{url('images/profile.jpg')}}" alt="">{{Session::get('inspectorId')['username']}}
                            </a>
                            <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                               
                            <a class="dropdown-item"  href="{{ route('logoutInspector') }}"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                            </div>
                          </li>
